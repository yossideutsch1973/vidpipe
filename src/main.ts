...
const texts: TextReference[] = [
  ...
  {
    reference:
      'Adrian Kaehler and Gary Bradski, Learning OpenCV 4: Computer Vision with Python, O\'Reilly Media, 2019.',
    description:
      'Practical guide to building vision applications using the OpenCV library.',
  },
  {
    reference:
      'Alan C. Bovik (ed.), The Essential Guide to Video Processing, 2nd ed., Academic Press, 2009.',
    description:
  ...
  {
    reference:
      'Tyler Akidau, Slava Chernyak, and Reuven Lax, Streaming Systems, O\'Reilly Media, 2018.',
    description:
      'Introduces concepts and architectures for real-time data processing pipelines.',
  },
  {
    reference:
      'James Densmore, Data Pipelines Pocket Reference, O\'Reilly Media, 2021.',
    description:
